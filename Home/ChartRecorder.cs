...
namespace Home
{
    ...
    {
        static DateTime UTCTimeBase = new DateTime(1970, 1, 1);

        public static double ToJavaTimestampUTC(this DateTime time)
        {
            return (time.ToUniversalTime() - UTCTimeBase).TotalMilliseconds;
        }
    }
}
